...
//            ControladorJugadores.getInstancia().agregarJugador("DNI", 36875123, "Luis Angel", "Salmeron", 6, LocalDate.of(1982, 3, 18), "Su casa 9", "lsalmeron@mail.com", "258147369");
            ...
            ControladorJugadores.getInstancia().agregarJugador("DNI", 61648656, "Marcos", "Rojo", 1, LocalDate.of(1990, 3, 20), "Su casa 4", "mrojo@mail.com", "+54 11 9796-8021");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 85220626, "Lisandro", "Lopez", 1, LocalDate.of(1989, 9, 1), "Su casa 5", "llopez@mail.com", "+54 11 8553-4509");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 98672345, "Carlos", "Zambrano", 1, LocalDate.of(1989, 7, 10), "Su casa 6", "czambrano@mail.com", "+54 11 7840-6406");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 64051816, "Frank", "Fabra", 1, LocalDate.of(1991, 2, 22), "Su casa 7", "ffabra@mail.com", "+54 11 4282-5377");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 19703542, "Valentin", "Barco", 1, LocalDate.of(2004, 7, 23), "Su casa 8", "vbarco@mail.com", "+54 11 7574-4028");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 88941666, "Marcelo", "Weigandt", 1, LocalDate.of(2000, 1, 11), "Su casa 9", "mweigandt@mail.com", "+54 11 2016-5915");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 91867074, "Luis", "Advincula", 1, LocalDate.of(1990, 3, 2), "Su casa 10", "ladvincula@mail.com", "+54 11 2042-7052");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 97678613, "Alan", "Varela", 1, LocalDate.of(2001, 7, 4), "Su casa 11", "avarela@mail.com", "+54 11 1142-3898");

            //RIVER 12 - 23
            ControladorJugadores.getInstancia().agregarJugador("DNI", 30458741, "Marcelo Daniel", "Gallardo", 2, LocalDate.of(1976, 1, 18), "Su casa 15", "mgallardo@mail.com", "+54 11 1945-6216");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 31587652, "Franco", "Armani", 2, LocalDate.of(1986, 10, 16), "Su casa 12", "farmani@mail.com", "+54 11 8372-6286");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 76468954, "Paulo", "Diaz", 2, LocalDate.of(1994, 8, 25), "Su casa 13", "pdiaz@mail.com", "+54 11 1850-6703");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 73927657, "David", "Martinez", 2, LocalDate.of(1998, 1, 21), "Su casa 14", "dmartinez@mail.com", "+54 11 2865-9858");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 33411994, "Robert", "Rojas", 2, LocalDate.of(1996, 4, 30), "Su casa 15", "rrojas@mail.com", "+54 11 2160-9584");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 99736264, "Javier", "Pinola", 2, LocalDate.of(1983, 2, 24), "Su casa 16", "jpinola@mail.com", "+54 11 6839-4948");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 77657557, "Jonatan", "Maidana", 2, LocalDate.of(1985, 7, 29), "Su casa 17", "jmaidana@mail.com", "+54 11 6838-1240");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 17561691, "Milton", "Casco", 2, LocalDate.of(1988, 4, 11), "Su casa 18", "mcasco@mail.com", "+54 11 3813-4036");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 33470348, "Enzo", "Perez", 2, LocalDate.of(1989, 2, 22), "Su casa 19", "eperez@mail.com", "+54 11 5635-7409");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 41563870, "Bruno", "Zuculini", 2, LocalDate.of(1993, 4, 2), "Su casa 20", "bzuculini@mail.com", "+54 11 7037-2077");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 40219851, "Leonardo", "Ponzio", 2, LocalDate.of(1982, 1, 29), "Su casa 21", "lponzio@mail.com", "+54 11 4764-8036");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 76202349, "Nicolas", "De La Cruz", 2, LocalDate.of(1997, 6, 1), "Su casa 22", "ndelacruz@mail.com", "+54 11 8012-4099");

            //RACING 24 - 32
            ControladorJugadores.getInstancia().agregarJugador("DNI", 59424211, "Gabriel", "Arias", 3, LocalDate.of(1987, 9, 13), "su casa 23", "garias@mail.com", "+54 11 3151-4751");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 75473477, "Gaston", "Gomez", 3, LocalDate.of(1996, 3, 4), "su casa 24", "ggomez@mail.com", "+54 11 4543-6615");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 15913806, "Diego", "Milito", 3, LocalDate.of(1998, 2, 19), "su casa 25", "mtagliamonte@mail.com", "+54 11 2960-8836");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 37035851, "Imanol", "Segovia", 3, LocalDate.of(2001, 2, 6), "su casa 26", "isegovia@mail.com", "+54 11 6649-1475");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 67575649, "Nery", "Dominguez", 3, LocalDate.of(1990, 4, 9), "su casa 27", "ndominguez@mail.com", "+54 11 8845-0104");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 46882459, "Leonardo", "Sigali", 3, LocalDate.of(1987, 5, 29), "su casa 28", "lsigali@mail.com", "+54 11 5346-5580");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 23512502, "Lucas", "Orban", 3, LocalDate.of(1989, 2, 3), "su casa 29", "lorban@mail.com", "+54 11 3217-4261");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 27078447, "Joaquin", "Novillo", 3, LocalDate.of(1998, 2, 19), "su casa 30", "jnovillo@mail.com", "+54 11 7265-8614");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 53737840, "Mauricio", "Martinez", 3, LocalDate.of(1993, 2, 20), "su casa 31", "mmartinez@mail.com", "+54 11 8055-8220");

            //INDEPENDIENTE 33 - 47
            ControladorJugadores.getInstancia().agregarJugador("DNI", 28754213, "Ricardo Enrique", "Bochini", 4, LocalDate.of(1954, 1, 25), "Su casa 32", "rbochini@mail.com", "+54 11 3212-6740");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 86947307, "Sebastian", "Sosa", 4, LocalDate.of(1986, 8, 19), "Su casa 33", "ssosa@mail.com", "+54 11 4967-5743");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 63110117, "Milton", "Alvarez", 4, LocalDate.of(1989, 1, 26), "Su casa 34", "malvares@mail.com", "+54 11 3951-2326");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 41916667, "Renzo", "Bacchia", 4, LocalDate.of(1999, 1, 23), "Su casa 35", "rbacchia@mail.com", "+54 11 3340-9927");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 55047867, "Sergio", "Barreto", 4, LocalDate.of(1999, 1, 24), "Su casa 36", "sbarreto@mail.com", "+54 11 4888-9037");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 61879086, "Joaquin", "Laso", 4, LocalDate.of(1990, 7, 4), "Su casa 37", "jlaso@mail.com", "+54 11 7482-2266");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 11721073, "Juan Manuel", "Insaurralde", 4, LocalDate.of(1984, 10, 3), "Su casa 38", "jminsaurralde@mail.com", "+54 11 6757-1865");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 15651148, "Ezequiel", "Munoz", 4, LocalDate.of(1990, 10, 8), "Su casa 39", "emunoz@mail.com", "+54 11 7159-6606");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 22655071, "Ayrton", "Costa", 4, LocalDate.of(1999, 7, 12), "Su casa 40", "acosta@mail.com", "+54 11 2719-4038");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 51690492, "Patricio", "Ostachuk", 4, LocalDate.of(2000, 5, 5), "Su casa 41", "postachuk@mail.com", "+54 11 2141-7894");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 31706178, "Lucas", "Rodriguez", 4, LocalDate.of(1993, 9, 27), "Su casa 42", "lrodriguez@mail.com", "+54 11 5978-5956");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 23951804, "Thomas", "Ortega", 4, LocalDate.of(2000, 12, 6), "Su casa 43", "tortega@mail.com", "+54 11 9462-3566");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 21426709, "Fabricio", "Bustos", 4, LocalDate.of(1996, 4, 28), "Su casa 44", "fbustos@mail.com", "+54 11 2061-1465");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 17214787, "Gonzalo", "Asis", 4, LocalDate.of(1996, 3, 28), "Su casa 45", "gasis@mail.com", "+54 11 3601-3364");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 56553617, "Lucas", "Romero", 4, LocalDate.of(1994, 4, 18), "Su casa 46", "lromero@mail.com", "+54 11 7380-8024");


            //SAN LORENZO 48 - 53
            ControladorJugadores.getInstancia().agregarJugador("DNI", 38811500, "Augusto", "Batalla", 5, LocalDate.of(1996, 4, 30), "Su casa 47", "abatalla@mail.com", "+54 11 4381-5831");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 42030784, "Sebastian Alberto", "Torrico", 5, LocalDate.of(1980, 2, 22), "Su casa 48", "storrico@mail.com", "+54 11 1243-9039");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 38439359, "Francisco", "Flores", 5, LocalDate.of(2002, 1, 11), "Su casa 49", "fflores@mail.com", "+54 11 4362-9663");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 37897231, "Federico", "Gatoni", 5, LocalDate.of(1999, 2, 16), "Su casa 50", "fgatoni@mail.com", "+54 11 2457-5962");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 58334276, "Alejandro", "Donatti", 5, LocalDate.of(1986, 10, 24), "Su casa 51", "adonatti@mail.com", "+54 11 7280-4273");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 67743381, "Gino", "Peruzzi", 5, LocalDate.of(1992, 6, 9), "Su casa 52", "gperuzzi@mail.com", "+54 11 1471-7022");


            //FERRO 54 - 59
            ControladorJugadores.getInstancia().agregarJugador("DNI", 36875123, "Luis Angel", "Salmeron", 6, LocalDate.of(1982, 3, 18), "Su casa 53", "lsalmeron@mail.com", "+54 11 4431-6487");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 44534244, "Juan", "Perez", 6, LocalDate.of(1999, 3, 24), "Su casa 54", "jperez@mail.com", "+54 11 2695-1540");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 53026193, "Pedro", "Gomez", 6, LocalDate.of(1999, 4, 21), "Su casa 55", "pgomez@mail.com", "+54 11 7101-5091");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 99901795, "Alejandro", "Giordanengo", 6, LocalDate.of(2002, 6, 6), "Su casa 56", "agiordanengo@mail.com", "+54 11 2298-6262");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 78549602, "Nicolas", "Pandolfi", 6, LocalDate.of(1988, 4, 22), "Su casa 57", "npandolfi@mail.com", "+54 11 3045-6962");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 93742159, "Esteban", "Carnicer", 6, LocalDate.of(2004, 3, 4), "Su casa 58", "ecarnicer@mail.com", "+54 11 7391-5913");


            //BANFIELD 60 - 64
            ControladorJugadores.getInstancia().agregarJugador("DNI", 58029954, "James David", "Rodriguez", 7, LocalDate.of(1991, 7, 12), "Su casa 59", "jrodriguez@mail.com", "+54 11 2217-7713");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 92149154, "Facundo", "Altamirano", 7, LocalDate.of(1996, 3, 21), "Su casa 60", "faltamirano@mail.com", "+54 11 2932-0700");
            ControladorJugadores.getInstancia().agregarJugador("DNI", 58698841, "Gregorio", "Tanco", 7, LocalDate.of(1999, 10, 10), "Su casa 61", "gtanco@mail.com", "+54 11 3834-2003");
